...
class UnitreeEnvMini(PipelineEnv):
    ...
    def rewards(self, state: State, data):
        ...
        reward = period_reward + healthy_reward + footstep_reward + upright_reward + jl_reward + flatfoot_reward + velocity_reward + pelvis_a_reward + stride_length_reward + swing_height_reward + footplace_reward
        done = 1.0 - is_healthy
