...
class NemoEnv(PipelineEnv):
    ...
    def reset(self, rng: jax.Array) -> State:
        ...
        push_interval_steps = jnp.round(push_interval / self.dt).astype(jp.int32)
    ...
    def step(self, state: State, action: jnp.ndarray):
        ...
        should_push = jnp.mod(state.info["push_step"] + 1, state.info["push_interval_steps"]) == 0
